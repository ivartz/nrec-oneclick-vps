...
echo "Session 2: SSH with local port = 55902, start a vncserver with :2"
echo "Session 3: SSH with local port = 55903, start a vncserver with :3"
echo "..."
echo "Tips:"
echo "Set correct timezone in the VM with:"
echo "sudo timedatectl set-timezone Europe/Oslo"
echo "Connect Hermes to gpt.uio.no:"
echo "hermes setup -> Full Setup -> Custom endpoint (enter URL manually) -> Copy paste URL and key etc. then Enter -> Exit with ctrl + c, ctrl + c"
